# Generated by Django 4.0 on 2021-12-22 14:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.BooleanField(default=True, verbose_name='Activado/No Activado')),
                ('fecha_creacion', models.DateField(auto_now_add=True, verbose_name='Fecha de Creacion')),
                ('autor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='my_blog.autor')),
                ('categoria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='my_blog.categoria')),
            ],
            options={
                'verbose_name': 'Post',
